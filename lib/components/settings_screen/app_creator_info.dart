                        ...
                        snapshot.data!['socialNetworkingProfiles']
                            .map<Widget>((social) => RawMaterialButton(
                                  ...
                                  constraints: BoxConstraints(
                                      ...
                                      maxHeight: 64.0),
                                  child: Image.network(
                                    '${Constants.baseUrl}/dist/images/brownboycodes/social_icons/colorable/${social['avatar']}',
                                  ),
                                ))
                            .toList();
                          ...
                          CircleAvatar(
                              ...
                              child: ClipOval(
                                child: AspectRatio(
                                  aspectRatio: 1.0 / 1.0,
                                  child: Image.network(
                                    '${Constants.baseUrl}/dist/images/hadwin_images/attributions/${snapshot.data!['avatar']}',
                                    height: 120,
                                    width: 120,
                                    fit: BoxFit.contain,
                                  ),
